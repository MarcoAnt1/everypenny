...
ALTER TABLE "AccountShare" ALTER COLUMN "role" DROP DEFAULT;
ALTER TABLE "AccountShare" ALTER COLUMN "role" TYPE "ShareRole_new" USING ("role"::text::"ShareRole_new");
ALTER TYPE "ShareRole" RENAME TO "ShareRole_old";
ALTER TYPE "ShareRole_new" RENAME TO "ShareRole";
DROP TYPE "ShareRole_old";
ALTER TABLE "AccountShare" ALTER COLUMN "role" SET DEFAULT 'EDITOR';
COMMIT;
