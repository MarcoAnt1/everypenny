    ...
    <div class="space-y-6">
        ...
        <div v-else class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div v-if="incomeCategories.length === 0" class="text-sm text-gray-400 py-4 text-center">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div v-if="expenseCategories.length === 0" class="text-sm text-gray-400 py-4 text-center">
            ...
            <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-md">
                ...
                <div class="space-y-4">
                    ...
                    <div v-if="parentId && !editingCategory">
                        <label class="text-sm text-gray-600 font-medium">Parent Category</label>
                        <p class="mt-1 text-sm text-indigo-600 font-medium px-3 py-2 bg-indigo-50 rounded-lg">
                            {{ parentCategoryName }}
                        </p>
                    </div>
                    ...
                    <div v-if="editingCategory">
                        <label class="text-sm text-gray-600 font-medium">Parent Category (optional)</label>
                        <select 
        ...
        >
            <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-sm text-center">
                ...
                <p class="text-sm text-gray-400 mb-6">
                    This will permanently delete <strong>{{ deletingCategory?.name }}</strong>.
                </p>
...
const incomeCategories = computed(() => categories.value.filter(c => c.type === 'income' && !c.parentId));
const expenseCategories = computed(() => categories.value.filter(c => c.type === 'expense' && !c.parentId));
